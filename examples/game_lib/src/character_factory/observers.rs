...
pub fn assemble_character(
    ...
    let spine = SpineController {
        ...
        config: SpineConfig {
            ...
            drive_muscle: blueprint.data.spine.drive_muscle,
            speed_target: blueprint.data.spine.speed_target,
            accel_max: blueprint.data.spine.accel_max,
            speed_gain: blueprint.data.spine.speed_gain,
            heading_gain: blueprint.data.spine.heading_gain,
            omega_max: blueprint.data.spine.omega_max,
            omega_gain: blueprint.data.spine.omega_gain,
